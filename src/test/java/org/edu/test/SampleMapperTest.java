...
@WebAppConfiguration //JUnit과 AOP동시사용 에러처리 위해
...
*/	java.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat("yyyyMMddHHmmss");
	...
	//testSelectMember(); //입력전 조회 //AOP로 디버그할거기에 필요없음
	//System.out.println("위쪽은 입력 전 리스트 입니다."); //AOP로 디버그할거기에 필요없음
	...
	//System.out.println("아래쪽은 입력 후 리스트 입니다."); //AOP로 디버그할거기에 필요없음
	//testSelectMember(); //입력 후 조회. 워크밴치 안가도 나오게 .AOP로 디버그할거기에 필요없음
	}
	...
	public void testUpdateMember() {//매개변수있으나 ()에 안 쓰고 안에 써줌.
		//testSelectMember(); //수정전 보여줌 //AOP로 디버그할거기에 필요없음
		//System.out.println("위에서 수정 전 이름을 확인하세요."); //AOP로 디버그할거기에 필요없음
		...
		//System.out.println("아래는 수정 후 이름을 확인하세요."); //AOP로 디버그할거기에 필요없음
		//testSelectMember(); //AOP로 디버그할거기에 필요없음
	...
	public void testDeleteMember() {
		...
		//System.out.println("아래는 지운 후 회원리스트입니다."); //AOP로 디버그할거기에 필요없음
		//testSelectMember(); //AOP로 디버그할거기에 필요없음
	}
	//DB연동방식1
	...
	public void testUserId(){
		...
		String userid = mapper.getUserId("eunhwa");
